...
const (
	...
	splitWithPreviewMsg     = "incite: split incompatible with preview"
	splitWithoutMaxLimitMsg = "incite: split requires MaxLimit"
	reSplitWithoutSplitMsg  = "incite: re-split requires split"
	exceededMaxSplitMsg     = "incite: exceeded MaxSplit"
